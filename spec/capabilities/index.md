...
|-----------|------|----------|
| Dataset Ingestion | [dataset-ingestion.md](dataset-ingestion.md) | 1 (upload/clean/profile single CSV/TSV/XLSX), 2 (library), 3a (derived/exported datasets), 3d (PDF best-effort + `.xls` + multi-sheet Excel note) |
